...
const (
	...
	endpointChallangesBase                              = endpointBase + "/challenges/v1"
	endpointChallangesBaseChallenges                    = endpointChallangesBase + "/challenges"
	endpointChallangesConfig                            = endpointChallangesBaseChallenges + "/config"
	endpointChallangesPercentiles                       = endpointChallangesBaseChallenges + "/percentiles"
	endpointChallangesConfigByChallengeId               = endpointChallangesBaseChallenges + "/%d/config"
	endpointChallangesLeaderboardsByChallengeIdAndLevel = endpointChallangesBaseChallenges + "/%d/leaderboards/by-level/%s?limit=%d"
	endpointChallangesPercentilesByChallengeId          = endpointChallangesBaseChallenges + "/%d/percentiles"
	endpointChallangesPlayerdataByPuuid                 = endpointChallangesBase + "/player-data/%s"
	...
	endpointGetMatchIDs                                 = endpointMatchBase + "/matches/by-puuid/%s/ids?start=%d&count=%d"
